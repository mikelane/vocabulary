...
class TestModule(unittest.TestCase):
    ...
    def test_meaning_found(self, mock_api_call):
        ...
        expected_result = (
            '[{"seq": 0, "text": "the act of singing with closed lips"}]'
        )
    ...
    def test_synonynm_found(self, mock_api_call):
        res = {
            "tuc": [
                {"phrase": {"text": "get angry", "language": "en"}},
                {"phrase": {"text": "mad", "language": "en"}},
            ]
        }
        ...
        expected_result = (
            '[{"text": "get angry", "seq": 0}, {"text": "mad", "seq": 1}]'
        )
        expected_result = json.dumps(json.loads(expected_result))
    ...
    def test_translate_found(self, mock_api_call):
        res = {
            "tuc": [
                {"phrase": {"text": "anglais", "language": "fr"}},
                {"phrase": {"text": "germanique", "language": "fr"}},
            ]
        }
        ...
        expected_result = (
            '[{"text": "anglais", "seq": 0}, {"text": "germanique", "seq": 1}]'
        )
        expected_result = json.dumps(json.loads(expected_result))
    ...
    def test_partOfSpeech_found(self, mock_api_call):
        ...
        expected_result = (
            ...
            ' {"text": "verb-intransitive", "example": "To call.", "seq": 1}]'
        )
    ...
    def test_usageExample_found(self, mock_api_call):
            ...
            "list": [
                {
                    ...
                    "word": "hillock",
                    "example": (
                        "I went to the to of the hillock to look around."
                    ),
                    "thumbs_down": 3,
                }
            ]
        ...
        expected_result = (
            '[{"seq": 0,'
            ' "text": "I went to the to of the hillock to look around."}]'
        )
    ...
    def test_pronunciation_found(self, mock_api_call):
        res = [
            {"rawType": "ahd-legacy", "seq": 0, "raw": "hip"},
            {
                "rawType": "arpabet",
                "seq": 0,
        ...
        expected_result = (
            '[{"rawType": "ahd-legacy", "raw": "hip", "seq": 0},'
            ' {"rawType": "arpabet",'
            ' "raw": "HH IH2 P AH0 P AA1 T AH0 M AH0 S", "seq": 1}]'
        )
    ...
    def test_hyphenation_found(self, mock_api_call):
        res = [
            {"seq": 0, "type": "secondary stress", "text": "hip"},
            {"seq": 1, "text": "po"},
        ]
        ...
        expected_result = (
            '[{"seq": 0, "text": "hip", "type": "secondary stress"},'
            ' {"seq": 1, "text": "po"}]'
        )
